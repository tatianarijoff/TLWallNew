"""
Example: Read vacuum configuration, compute impedances and export results.

Demonstrates:
- How to load a tlwall configuration from a .cfg file (vacuum-like case)
...
def example_vac_from_cfg():
    """Example: Vacuum-like chamber from configuration file."""
    print("=" * 70)
    print("Example: Vacuum Configuration from ex_Vac.cfg")
    print("=" * 70)

    # ------------------------------------------------------------------
    # Read configuration and build TlWall object
    # ------------------------------------------------------------------
    cfg_path = os.path.join("examples/ex_Vac", "ex_Vac.cfg")
    ...
    # Save data to Excel
    # ------------------------------------------------------------------
    outdir_data = os.path.join("examples/ex_Vac", "output")
    ...
    # Plot impedances
    # ------------------------------------------------------------------
    outdir_img = os.path.join("examples/ex_Vac", "img")
...
if __name__ == "__main__":
    example_vac_from_cfg()
    print("=" * 70)
    print("Vacuum example completed successfully!")
    print("=" * 70)
