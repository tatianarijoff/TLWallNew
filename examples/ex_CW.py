"""
Example: Read coated-wall configuration, compute impedances and export results.

Demonstrates:
- How to load a tlwall configuration from a .cfg file (coated-wall case)
...
def example_cw_from_cfg():
    """Example: Coated-wall chamber from configuration file."""
    print("=" * 70)
    print("Example: Coated-Wall Configuration from ex_CW.cfg")
    print("=" * 70)

    # ------------------------------------------------------------------
    # Read configuration and build TlWall object
    # ------------------------------------------------------------------
    cfg_path = os.path.join("examples/ex_CW", "ex_CW.cfg")
    ...
    # Save data to Excel
    # ------------------------------------------------------------------
    outdir_data = os.path.join("examples/ex_CW", "output")
    ...
    # Plot impedances
    # ------------------------------------------------------------------
    outdir_img = os.path.join("examples/ex_CW", "img")
...
if __name__ == "__main__":
    example_cw_from_cfg()
    print("=" * 70)
    print("Coated-wall example completed successfully!")
    print("=" * 70)
